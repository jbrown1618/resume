...
\newcommand{\company}[1]{
  \subheaderStyle{#1}\vspace{-6pt}
}

% 1 (description/title), 2 (date range)
\newcommand{\experienceHeader}[2]{
  \subheaderStyle{#1} \dateStyle{#2}
}

% 1 (description/title), 2 (company/context), 3 (date range), 4 (bulleted list of items)
\newcommand{\experience}[3]{
  \listWithTitle{\experienceHeader{#1}{#2}}{#3}
}

% 1 (description), 4 (bulleted list of items)
\newcommand{\project}[2]{
  \listWithTitle{\subheaderStyle{#1}}{#2}
}

\newcommand{\leadershipExperience}[4]{
  \listWithTitle{\subheaderStyle{#1,} #2 \dateStyle{#3}}{#4}
}
