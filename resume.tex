...
\resumeSection{Work Experience}{
  \experience{Senior Associate Software Developer}{SAS Software}{2017-Present}{
    \item Developed a client-facing application based on portable C++ libraries using WASM and ASM.js
    \item Led development of a testing framework for cross-project testing
  }
  ...
  \experience{Associate Software Development Engineer}{MetLife Inc.}{2015-2016}{
    ...
    \item Led automated end-to-end testing with Selenium to reduce dependency on offshore QA, leading to reduced cost for regression testing of framework-level changes
