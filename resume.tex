...
\resumeSection{Work Experience}{
  \experience{Software Development Engineer II}{MetLife Inc.}{2016-Present}{
    \item Led a small team in building a proof-of-concept for a ``next-phase`` application build on Spring Boot and Angular 4, which was in turn used as a prototype for projects company-wide
	...
	\item Implemented a report automation system through which users customize regularly-scheduled reports for the underwriters
    \item Enforced best practices and design principles by conducting code reviews
  }
  
  \experienceHeader{Software Development Engineer I}{MetLife Inc.}{2015-2016}\\
  \experience{Associate Software Development Engineer}{MetLife Inc.}{2014-2015}{
    ...
    \item Led automated end-to-end testing with Selenium to reduce dependency on offshore QA and closer adherence to Agile principles
  }
